...
void BodySteering::updateKinematic(const uint32_t dt, const KinematicSteering& steering) {
...
void BodySteering::updateSteering(const uint32_t dt, const Steering& steering) {
  const float time = dt * 0.001f;             //dt comes in miliseconds
